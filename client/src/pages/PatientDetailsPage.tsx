          ...
          <div className='text-2xl'>
            ...
            <div className='border-t flex flex-col justify-center items-center py-14 px-20 ' >
              ...
              {patient.next_of_kin_name && patient.next_of_kin_name.trim() !== "" && (
                <div className='mt-5 w-[50%] py-5 rounded-lg border px-2 bg-neutral-100' >
                  <div className="flex justify-center items-center">
                    <div className="flex w-full  py-3 border-b justify-center ">
                  ...
                  <div className="flex justify-center items-center">
                    <div className="grid w-[80%] grid-cols-2 justify-center items-center gap-5">
                      <p className="capitalize">Name: {patient.next_of_kin_name}</p>
                      <p className="capitalize">Address: {patient.next_of_kin_address}</p>
                      <p className="capitalize">Phone Number: {patient.next_of_kin_number}</p>
                      <p className="capitalize">Relationship: {patient.next_of_kin_relationship}</p>
                    </div>
                  </div>
                </div>
              )}
