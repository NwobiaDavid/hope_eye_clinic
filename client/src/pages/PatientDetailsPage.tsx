...
// Define interfaces for the patient data and the component's state
interface Patient {
  firstName: string;
  lastName: string;
  regStatus: string;
...
const PatientDetailsPage: React.FC = () => {
  ...
  const [nextRelationship, setNextRelationship] = useState<string>("");
  ...
  const handleNewGenderChange = (gender: string) => {
    setNewGender(gender);
  };

  const handleNewStatusChange = (status: string) => {
    setNewStatus(status);
  };
...
<div className='mr-5'>
  <Link className="bg-black p-2 rounded-lg text-white hover:bg-slate-800 duration-200" to={"/"}> Back </Link>
</div>

<div>
  <h2 className="text-3xl font-semibold">Hope Eye Clinic</h2>
</div>
      </div>
              ...
              <div className='text-2xl'>
                <div className='flex relative justify-center p-14 items-center'>
                  ...
                  <div className='ml-4'>
                    ...
                    <p>{patient.note?.trim() === "" ? "no doc note" : patient.note}</p>
                  </div>
                        ...
                        <div className="grid gap-4 py-4">
                          <div className='grid grid-cols-2 gap-3'>
                            ...
                            <div className="w-full grid gap-4 grid-cols-4 text-center justify-center border-2 border-slate-400 bg-slate-300 items-center rounded-lg px-2">
                              <Label htmlFor="consultationFee" className="text-right whitespace-nowrap capitalize">
                                Consultation Fee
                              </Label>
                          ...
                          <div className='grid grid-cols-2 gap-5'>
                            ...
                            <div className="grid grid-cols-1 items-center gap-4">
                              <div>
                                <Label htmlFor="nextAddress" className="whitespace-nowrap text-right">
                  ...
                  <div className='w-full'>
                    <div className="flex justify-center items-center">
                      <div className='flex w-[90%] py-3 border-b justify-between'>
                        ...
                        <div className={`border rounded-lg p-1 ${patient.regStatus === "Not Paid" ? "border-red-500 text-red-700 bg-red-200" : "border-green-500 bg-green-200 text-green-700"}`}>
                          {patient.regStatus}
                        </div>
                      </div>
                    </div>
                ...
                <div className="border-t">
                  <ConsultationComp id={Number(id)} />
                </div>
                <div className="border-t">
                  <AppointmentComp id={Number(id)} />
                </div>
                <div>
                  <CartComponent id={Number(id)} />
                </div>
                <div className="border-t">
                  <TestComp id={Number(id)} />
                </div>
                <div className="border-t">
                  <SurgeryComp id={Number(id)} />
                </div>
              </div>
            </div>
          ) : (
